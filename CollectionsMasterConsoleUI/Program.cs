...
namespace CollectionsMasterConsoleUI
{
    class Program
    {
        ...
        private static void ReverseArray(int[] numbers, int i)
        {
        ...
        private static void Populator(List<int> numList)
        {
            throw new NotImplementedException();
        }

        private static void EvenKiller(List<int> numList)
        {
            throw new NotImplementedException();
        }
        ...
        private static void NumberChecker(List<int> numberList, int searchNumber)
        {
            ...
            {
                Console.WriteLine($"These aren't the droids your're looking for");
